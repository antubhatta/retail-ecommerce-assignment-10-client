  ...
  return (
    <section className="bg-gray-100 dark:bg-slate-800 py-12">
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-semibold dark:text-white text-gray-800 mb-4">Why Choose Us</h2>
        <p className="text-sm lg:text-lg w-auto lg:w-[450px] mx-auto dark:text-white text-gray-600 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="rounded-lg p-6 dark:bg-slate-800 bg-white shadow-lg">
            <div className="text-2xl text-blue-500 mb-4">
              <i className="text-7xl flex justify-center"><FaShippingFast></FaShippingFast></i>
            </div>
            <h3 className="text-xl dark:text-white font-semibold mb-2">Fast Shipping</h3>
            <p className="text-gray-600 text-sm lg:text-lg dark:text-white">
          ...
          <div className="rounded-lg p-6 dark:bg-slate-800 bg-white  shadow-lg">
            ...
            <h3 className="text-xl dark:text-white font-semibold mb-2">Wide Selection</h3>
            <p className="text-gray-600 text-sm lg:text-lg dark:text-white">
          ...
          <div className="rounded-lg p-6 dark:bg-slate-800 bg-white shadow-lg">
            ...
            <h3 className="text-xl dark:text-white font-semibold mb-2">Exceptional Support</h3>
            <p className="text-gray-600 text-sm lg:text-lg dark:text-white">
