    ...
    return (
        ...
        <div className="hero-content flex-col">
          <div className="text-center ">
            <h1 className="text-xl lg:text-3xl text-[#FFF] font-bold mb-4">Login your Account</h1>
          ...
          <div className="card flex-shrink-0 w-[300px] md:w-full shadow-2xl bg-base-100 ">
            <form onSubmit={handleLogin} className="card-body">
              ...
              <button className="py-4 rounded-md text-white bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 w-auto md:w-[400px]">Login</button>
              </div>
